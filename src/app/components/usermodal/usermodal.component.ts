...
export class UsermodalComponent{
  ...
  constructor(private formBuilder:FormBuilder,private global:GlobalService,private alerts: AlertService, private mctrl: ModalController, private userService: UserService) { }
  dismiss() {
    this.mctrl.dismiss();
  }
  update(i, n, e, p, pe) {
